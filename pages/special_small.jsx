...
export default function SpecialLarge(props) {
  return <Layout>
    ...
    <a target="_blank" href="https://github.com/alexey-dc/pm2_nextjs_express_template/blob/main/pages/special_small.jsx"> See page source </a>
    <p> The <a target="_blank" href="https://github.com/alexey-dc/pm2_nextjs_express_template/blob/main/app/routes/pages.js#L24">backend logic for this route</a> renders a different page depending on the value (currently {props.value}). </p>
